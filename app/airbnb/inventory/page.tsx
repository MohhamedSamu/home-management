...
export default function AirbnbInventoryPage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesSupplier = !filterSupplier || 
      (product.supplier && product.supplier.toLowerCase().includes(filterSupplier.toLowerCase()))
    const matchesInventoryLevel = !filterInventoryLevel || product.inventory_level === filterInventoryLevel
    return matchesSearch && matchesSupplier && matchesInventoryLevel
  })
    ...
    <main className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold">Airbnb Inventory</h1>
        ...
        <div className="space-y-2">
          {filteredProducts.length === 0 ? (
            <p className="text-gray-600 dark:text-gray-400">
              {searchQuery || filterSupplier ? 'No products found' : 'No products in inventory yet.'}
            </p>
          ) : (
